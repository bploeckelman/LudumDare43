...
public class Audio implements Disposable {
    ...
    public enum Musics {
        RockHardyWithMaster,
        SillySpaceDrumsWithMaster,
        SpaceAmbWithMaster,
        SpaceDramaWithMaster,
        XmenKnockersWithMaster,
        SpaceFanfareWithMaster
    }
    ...
    private LudumDare43 game;

    public Audio(LudumDare43 game) {
        this(!shutUpYourTunes, game);
    }

    public Audio(boolean playMusic, LudumDare43 game) {
        this.game = game;
        ...
        putSound(Sounds.shot, game.assets.shot);
        putSound(Sounds.selected, game.assets.selected);
        putSound(Sounds.explosion_tiny, game.assets.explosionTiny);
